<% if the_module_name %>module <%=the_module_name%><% end %>
  require 'spec_helper'
  ...
  RSpec.describe <% if the_module_name %>module <%=the_module_name%>::<% end %><%= the_controller_name %>, :type => :controller do
    ...
    # 8 the_file_name: <%= the_file_name %>
    # 9 the_model_name: <%= the_model_name %>
    ...
    context "with a model " do
      before(:each) do
        create(:model, classname: '<%= the_model_name %>', name: '<%= the_model_name %>', tablename: '<%= the_table_name %>')
      end
      after(:each) do
      ...
      describe "GET index" do
        it "assigns all <%= the_table_name %> as @mega_instance" do
          <%= the_model_file_name %> = <%= the_model_name %>.create! valid_attributes
