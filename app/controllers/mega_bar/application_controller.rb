module MegaBar
  class ApplicationController < ActionController::Base
    ...
    before_action -> { @mega_displays = mega_displays_info(ModelDisplay.by_model(params[:model_id]).by_action(params[:action])) },  only: [:index, :show, :edit, :new] #not save or update..
