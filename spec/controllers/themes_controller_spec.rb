module MegaBar
  ...
  RSpec.describe MegaBar::ThemesController, :type => :controller do
    ...
    let(:fields_and_displays) {  create(:field_with_displays, field: 'tbd', tablename: 'mega_bar_themes', model_display_ids: model_model_display_ids) }
    ...
    let(:controlller) { 'themes' } #might need editing!
